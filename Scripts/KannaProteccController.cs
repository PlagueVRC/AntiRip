    ...
    public class KannaProteccController
    {
       ...
       public static string LayerName = "KannaProtecc";
        ...
        public void ValidateAnimations(GameObject gameObject, AnimatorController controller)
        {
            ...
            var meshRenderers = gameObject.GetComponentsInChildren<MeshRenderer>(true).Where(o => o?.sharedMaterials != null && o.sharedMaterials.Any(a => a != null)).ToArray();
            ...
            var skinnedMeshRenderers = gameObject.GetComponentsInChildren<SkinnedMeshRenderer>(true).Where(o => o?.sharedMaterials != null && o.sharedMaterials.Any(a => a != null)).ToArray();
