...
3. Shaders must be manually edited to work with Kanna Protecc. Currently this system will inject itself into the official Poiyomi 8/8.1 Toon Shader when you click "Encrypt Mesh". Any material which is not Poiyomi 8/8.1 will simply be ignored.
...
If you wish to see your avatar again as normal and not encrypted, unlock all of your Poiyomi materials. Kanna Protecc only writes itself into the locked Poiyomi shader files, so you can fully turn it off just by unlocking the materials again. Kanna Protecc has a utility for this. Click on your original non encrypted avatar and click unlock poi mats.
